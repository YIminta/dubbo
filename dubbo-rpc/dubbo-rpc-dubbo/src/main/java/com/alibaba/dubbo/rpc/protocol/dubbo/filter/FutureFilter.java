...
/**
 * EventFilter
 * 事件通知过滤器，可参见文档 <a href="https://cn.dubbo.apache.org/zh-cn/overview/mannual/java-sdk/advanced-features-and-usage/service/events-notify/">《Dubbo 用户指南 —— 事件通知》</a>
 */
...
public class FutureFilter implements Filter {
    ...
    private void fireReturnCallback(final Invoker<?> invoker, final Invocation invocation, final Object result) {
        ...
        if (rParaTypes.length > 1) {
            if (rParaTypes.length == 2 && rParaTypes[1].isAssignableFrom(Object[].class)) {//泛化调用
                params = new Object[2];
                params[0] = result;
                params[1] = args;
            } else {
