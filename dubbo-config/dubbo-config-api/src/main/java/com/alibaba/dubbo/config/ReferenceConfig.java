...
public class ReferenceConfig<T> extends AbstractReferenceConfig {
    ...
    private void init() {
        ...
        // 直连提供者，参见文档《直连提供者》https://cn.dubbo.apache.org/zh-cn/overview/mannual/java-sdk/advanced-features-and-usage/service/explicit-target/
        ...
        if (methods != null && !methods.isEmpty()) {
            for (MethodConfig method : methods) {
                ...
                // 将带有 @Parameter(attribute = true) 配置对象的属性，添加到参数集合。参见《事件通知》https://cn.dubbo.apache.org/zh-cn/overview/mannual/java-sdk/advanced-features-and-usage/service/events-notify/
    ...
    private T createProxy(Map<String, String> map) {
        ...
        // injvm 属性为空，不通过该属性判断
        if (isInjvm() == null) {
            // 直连服务提供者，参见文档《直连提供者》https://cn.dubbo.apache.org/zh-cn/overview/mannual/java-sdk/advanced-features-and-usage/service/explicit-target/
