...
public class MockClusterInvoker<T> implements Invoker<T> {
    ...
    public Result invoke(Invocation invocation) throws RpcException {
        ...
        } else if (value.startsWith("force")) {//【第二种】强制服务降级 https://cn.dubbo.apache.org/zh-cn/overview/mannual/java-sdk/advanced-features-and-usage/service/service-downgrade/
        ...
        } else { // 【第三种】失败服务降级 https://cn.dubbo.apache.org/zh-cn/overview/mannual/java-sdk/advanced-features-and-usage/service/service-downgrade/
            //fail-mock
            try {
                // 调用原 Invoker ，发起 RPC 调用
                result = this.invoker.invoke(invocation);
